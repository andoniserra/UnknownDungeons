...
public class SymbolsAdapted : MonoBehaviour {

	#region Simbolos y letras
	
	public static Sprite Ex {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[38];}
	}
	public static Sprite Coin {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[39];}
	}
	public static Sprite Coin2 {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[40];}
	}
	public static Sprite Heart {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[41];}
	}
	public static Sprite HeartMini {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[42];}
	}
	public static Sprite Mush {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[43];}
	}
	public static Sprite Copyright {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[44];}
	}
	public static Sprite Right {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[45];}
	}
	public static Sprite Left {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[46];}
	}
	public static Sprite Up {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[47];}
	}
	public static Sprite Down {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[48];}
	}
	public static Sprite BorderUpLeft {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[49];}
	}
	public static Sprite BorderUp {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[50];}
	}
	public static Sprite BorderUpRight {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[51];}
	}
	public static Sprite BorderLeft {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[52];}
	}
	public static Sprite BorderRight {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[53];}
	}
	public static Sprite BorderDownLeft {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[54];}
	}
	public static Sprite BorderDown {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[55];}
	}
	public static Sprite BorderDownRight {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[56];}
	}
	public static Sprite Cat {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[57];}
	}
	public static Sprite Blank {
		get{return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[58];}
	}
	...
	public static Sprite getLetra(char pLetra){
		...
		return Resources.LoadAll<Sprite>("Sprites/FontAdapted")[num];
	}
	...
	private static Vector3 colocar8x8(float posX, float posY){
		return new Vector3(
			(-76f + (posX*8)) * GLOBALS.UNITS_TO_PIXELS,
			(-68 + (posY * 8)) * GLOBALS.UNITS_TO_PIXELS);
	}
	...
	public static void caja(Vector2 pPos1, Vector2 pPos2){
		...
		colocarImagen(new GameObject(), SymbolsAdapted.BorderDownLeft, pPos1);
		colocarImagen(new GameObject(), SymbolsAdapted.BorderDownRight, new Vector2(pPos2.x, pPos1.y));
		colocarImagen(new GameObject(), SymbolsAdapted.BorderUpLeft, new Vector2(pPos1.x, pPos2.y));
		colocarImagen(new GameObject(), SymbolsAdapted.BorderUpRight, pPos2);
		
		//Raya abajo
		for(float x = pPos1.x + 1; x < pPos2.x; x++){
			colocarImagen(new GameObject(), SymbolsAdapted.BorderDown, new Vector2(x,pPos1.y));
		} 
		//Raya arriba
		for(float x = pPos1.x + 1; x < pPos2.x; x++){
			colocarImagen(new GameObject(), SymbolsAdapted.BorderUp, new Vector2(x,pPos2.y));
		} 
		//Raya Izquierda
		for(float y = pPos1.y + 1; y < pPos2.y; y++){
			colocarImagen(new GameObject(), SymbolsAdapted.BorderLeft, new Vector2(pPos1.x,y));
		} 
		//Raya Derecha
		for(float y = pPos1.y + 1; y < pPos2.y; y++){
			colocarImagen(new GameObject(), SymbolsAdapted.BorderRight, new Vector2(pPos2.x,y));
		} 
	}
